...
from app.views.game_embed import battle_embed, reaction_embed
from app.views.game_view import BattleGameView, ReactionRushGameView


log = logging.getLogger("discord.game_runtime")
...
class GameRuntimeService:
    ...
    async def edit_game_panel(
        ...
        *,
        ...
        from app.discord.game_presenter import edit_game_panel

        await edit_game_panel(
            bot=self.bot,
            games=self.games,
            game_type=game_type,
            embed=embed,
