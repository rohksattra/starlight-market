...
class Game(commands.Cog):
    ...
    def register_persistent_views(self) -> None:
        ...
        self.bot.add_view(TriviaGameView())
    ...
    @app_commands.choices(
        game=[
            ...
            app_commands.Choice(name="Trivia Quiz", value="trivia"),
    ...
    async def _handle_trivia_answer(self, message: discord.Message) -> None:
        state = await self.runtime.state("trivia")
        if not state:
            return
