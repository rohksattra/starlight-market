...
from app.uis.leaderboard_button import LeaderboardPaginationView, PAGE_SIZE
...
class Leaderboard(commands.Cog):
    ...
    async def _send_game_leaderboard_panel(
        ...
        *,
        ...
        game = self._game_cog()
        return await game._send_leaderboard_panel(channel=channel, game_type=game_type)
