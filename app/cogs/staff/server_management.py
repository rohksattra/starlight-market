...
from app.discord.server_actions import ServerService
...
class ServerManagement(commands.Cog):
    ...
    async def cleanupdata(self, ctx: commands.Context) -> None:
        ...
        try:
            ...
            await confirm_msg.edit(
                content="⏱️ Cleanup confirmation timed out."
            )
    ...
    @app_commands.describe(
        quantity="Number of messages to delete (max 100)",
    )
    async def delete_message(
        ...
        try:
            ...
            deleted = await self.server_serv.delete_messages(
        ...
        await safe_respond(
            interaction,
            content=f"🧹 Deleted **{deleted}** message(s).",
            ephemeral=True,
        )
