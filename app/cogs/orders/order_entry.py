...
from app.views.order_category_view import OrderCategoryView
from app.views.order_confirm_view import OrderConfirmView
from app.views.order_embed import order_embed, customer_total_price
from app.views.order_entry_embed import order_entry_embed
from app.views.embed_footer import button_notice_content_suffix
from app.views.order_entry_view import OrderEntryView
from app.views.order_item_view import OrderItemView
