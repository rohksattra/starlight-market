...
class OrderService:
    ...
    async def create_order(
        ...
        *,
        ...
        await self.users.ensure_user(customer_id)
        await self.users.inc_customer_order(user_id=customer_id)
    ...
    async def update_quantity(
        ...
        *,
        ...
        min_required = (
            claims["order_claimed"]
            + claims["order_completed"]
            + claims["order_delivered"]
        )
        ...
        updated = await self.orders.update_fields(
            ...
            fields={
                ...
                "order_claims.order_claimable": claims["order_claimable"] + diff,
            },
        )
