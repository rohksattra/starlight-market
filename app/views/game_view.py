...
class CountingGameView(_BaseGameView):
    ...
    async def refresh(self, interaction: discord.Interaction) -> None:
        ...
        try:
            handler = self._handler(interaction)

            state = await handler.runtime.state("counting")
            if not state:
                state = await handler.runtime.reset_counting()
...
class WordChainGameView(_BaseGameView):
    ...
    async def refresh(self, interaction: discord.Interaction) -> None:
        ...
        try:
            ...
            state = await handler.runtime.state("wordchain")
            if not state:
                state = await handler.runtime.reset_wordchain()
...
class GuessGameView(_BaseGameView):
    ...
    async def refresh(self, interaction: discord.Interaction) -> None:
        ...
        try:
            ...
            state = await handler.runtime.state("guess")
            if not state:
                state = await handler.runtime.reset_guess()
...
class ScrambleGameView(_BaseGameView):
    ...
    async def refresh(self, interaction: discord.Interaction) -> None:
        ...
        try:
            ...
            state = await handler.runtime.state("scramble")
            if not state:
                state = await handler.runtime.reset_scramble()
...
class TreasureGameView(_BaseGameView):
    ...
    async def claim(self, interaction: discord.Interaction) -> None:
        ...
        reward = await handler.runtime.claim_treasure(
...
class ReactionRushGameView(_BaseGameView):
    ...
    async def click(self, interaction: discord.Interaction) -> None:
        ...
        try:
            result = await handler.runtime.claim_reaction(
                user_id=str(interaction.user.id),
            )
    ...
    async def refresh(self, interaction: discord.Interaction) -> None:
        ...
        try:
            handler = self._handler(interaction)
            state = await handler.runtime.state("reaction")
...
class DailyGameView(_BaseGameView):
    ...
    async def claim(self, interaction: discord.Interaction) -> None:
        ...
        try:
            result = await handler.runtime.claim_daily(
                user_id=str(interaction.user.id),
            )
...
class BattleGameView(_BaseGameView):
    ...
    async def attack(self, interaction: discord.Interaction) -> None:
        ...
        result = await handler.runtime.attack_enemy(
    ...
    async def refresh(self, interaction: discord.Interaction) -> None:
        ...
        try:
            ...
            state = await handler.runtime.state(self.game_type)
            if not state:
                clear_refresh_cooldown(self._cooldowns, user_id)
