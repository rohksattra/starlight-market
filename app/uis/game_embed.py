...
def guess_embed(*, active: bool = True) -> discord.Embed:
    text = (
        ...
        if active
        else "Round ended — use 🔄 if the panel does not update."
    )
    ...
    embed = discord.Embed(
        ...
        description=(
            f"{text}\n\n"
            "✅ Correct: **+5 Guess Score** and **+15 SP**.\n"
...
def treasure_embed() -> discord.Embed:
    embed = discord.Embed(
        ...
        description=(
            ...
            "Common: **+2 Treasure Score** and **+10 SP**\n"
            "Rare: **+5 Treasure Score** and **+25 SP**\n"
            "Epic: **+10 Treasure Score** and **+50 SP**\n"
            "Legendary: **+20 Treasure Score** and **+100 SP**"
        ),
        color=0xFFD700,
    )
...
def reaction_embed(*, claimed_count: int = 0) -> discord.Embed:
    embed = discord.Embed(
        ...
        description=(
            ...
            "🥇 First: **+3 Reaction Score** and **+20 SP**\n"
            "🥈 Second: **+2 Reaction Score** and **+10 SP**\n"
            "🥉 Third: **+1 Reaction Score** and **+5 SP**\n\n"
