...
class UserRepository:
    ...
    async def inc_customer_order(
        ...
        *,
        ...
        await self.users.update_one(
            ...
            {
                "$inc": {
                    "total_customer_order": Int64(qty),
                },
                "$set": {
    ...
    async def dec_customer_order(
        ...
        *,
        ...
        new_val = max(
            0,
            int(doc.get("total_customer_order", 0)) - qty,
        )
    ...
    async def inc_customer_spent(
        ...
        *,
        ...
        await self.users.update_one(
            ...
            {
                "$inc": {
                    "total_customer_spent": Int64(amount),
                },
                "$set": {
                    "updated_at": datetime.utcnow(),
                },
    ...
    async def inc_starlight_points(
        self,
        *,
        user_id: str,
        points: int,
    ...
    async def get_rank_customer(
        ...
        spent = int(
            doc.get("total_customer_spent", 0),
        )
