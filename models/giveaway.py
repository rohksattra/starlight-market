"""Giveaway document shapes and status helpers."""
...
class GiveawayViewProjection(TypedDict, total=False):
    giveaway_id: str
    status: GiveawayStatus
    announcement_message_id: int | None
...
def giveaway_effective_status(doc: Giveaway | GiveawayViewProjection) -> GiveawayStatus:
