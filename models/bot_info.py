...
COMMAND_GROUPS: Final[list[CommandGroup]] = [
    {
        ...
        "commands": [
            ...
            {"name": "/monster-grind", "description": "Estimate average monster grind drops"},
        ],
    },
    {
    ...
    },
    {
        ...
        "commands": [
            ...
            {"name": "/override-order-quantity", "description": "Override order quantity without customer limit"},
