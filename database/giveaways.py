"""Mongo queries for the giveaways collection."""
...
from models.giveaway import (
    ...
    GiveawayStatus,
    GiveawayViewProjection,
)


class GiveawayRepo:
    def __init__(self, db_name: str) -> None:
        self.col = get_db(db_name).giveaways
    ...
    async def find_open_or_ended(self) -> List[GiveawayViewProjection]:
